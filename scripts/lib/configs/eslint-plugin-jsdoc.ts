...
// combined with typescript/tsdoc flavors and error variants). We only cover the three that
// differ meaningfully after filtering down to the rules oxlint supports.
